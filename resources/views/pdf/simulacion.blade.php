...
<div class="table-wrap">
  <table>
    <tr>
      ...
      <td>
        <div class="label">Pérdida eficiencia (%)</div>
        <div class="input">{{ number_format($perdida_eficiencia,2,',','.') }}</div>
      </td>
      <td>
        <div class="label">Tasa oportunidad (%)</div>
        <div class="input">{{ number_format($tasa_oportunidad,2,',','.') }}</div>
      </td>
    </tr>
    ...
    <tr>
      <td>
        ...
        <div class="input">{{ number_format($ipc,2,',','.') }}</div>
      </td>
      <td>
        <div class="label">Años depreciación</div>
        <div class="input">{{ (int)$anios_depreciacion }}</div>
      </td>
      <td colspan="2">
